...
router.get('/api/v1/events', (req, res, next) => {
  ...
  pg.connect(connectionString, (err, client, done) => {
    ...
    const query = client.query('SELECT proposal_id, proposal_name, event_date, event_signup_close, event_signup_open, cost_to_attendee, image_path, description, attendees FROM proposals WHERE event_date >= CURRENT_DATE ORDER BY event_date ASC;');
