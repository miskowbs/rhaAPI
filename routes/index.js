...
router.get('/api/v1/allEvents', (req, res, next) => {
  ...
  pg.connect(connectionString, (err, client, done) => {
    ...
    const query = client.query('SELECT proposal_id, proposal_name, event_date, quarter_proposed, week_proposed, money_requested, money_allocated, proposed_date, paid FROM proposals ORDER BY proposed_date DESC;');
